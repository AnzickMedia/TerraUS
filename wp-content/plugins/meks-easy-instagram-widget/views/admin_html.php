...
<p>
	...
	<select id="<?php echo $this->get_field_id( 'columns' ); ?>" name="<?php echo $this->get_field_name( 'columns' ); ?>" class="widefat">
		...
		<option value="9" <?php selected( $instance['columns'], 9 );?>> 9 </option>
		<option value="10" <?php selected( $instance['columns'], 10 );?>> 10 </option>
		<option value="11" <?php selected( $instance['columns'], 11 );?>> 11 </option>
		<option value="12" <?php selected( $instance['columns'], 12 );?>> 12 </option>
	</select>
