var twPageOptions={
	...
	init:function(){
		...
		if (jQuery('#maple_enable_breadcrumbs_value').length){
			jQuery('#maple_enable_breadcrumbs_value').change(function(){
				if (jQuery(this).val() == "yes"){
					jQuery('#maple_breadcrumbs_margin_top_noncename').parent().removeClass('optoff').css('display','block');
				} else {
					jQuery('#maple_breadcrumbs_margin_top_noncename').parent().addClass('optoff').css('display','none');
				}
			}).trigger('change');
		}
		...
		jQuery('#maple_enable_custom_pagetitle_options_value').change(function(){
			if (jQuery('#maple_enable_custom_pagetitle_options_value').val() == 'yes'){
				jQuery('#maple_header_type_value').closest('.option-container').css('display','block');
				showElements(jQuery('#maple_enable_custom_pagetitle_options_value').closest('.option-container').nextUntil(jQuery('.obsoluteoptionoptions')).removeClass('hiddenoption'), 0);
				jQuery('#maple_header_type_value').trigger('change');
				jQuery('#maple_enable_breadcrumbs_value').trigger('change');
			} else {
				hideElements(jQuery('#maple_enable_custom_pagetitle_options_value').closest('.option-container').nextUntil(jQuery('.obsoluteoptionoptions')).addClass('hiddenoption'), 0);
			}
		}).trigger('change');
		
		//custom header style options
		jQuery('#maple_enable_custom_header_options_value').change(function(){
			if (jQuery('#maple_enable_custom_header_options_value').val() == 'yes'){
				showElements( jQuery('#maple_custom_header_pre_value').closest('.option-container').add( jQuery('#maple_custom_header_after_value').closest('.option-container') ).add( jQuery('#maple_enable_website_loading_value').closest('.option-container') ).add( jQuery('#maple_content_to_the_top_value').closest('.option-container') ).removeClass('hiddenoption optoff') , 0);
			} else {
				hideElements( jQuery('#maple_custom_header_pre_value').closest('.option-container').add( jQuery('#maple_custom_header_after_value').closest('.option-container') ).add( jQuery('#maple_enable_website_loading_value').closest('.option-container') ).add( jQuery('#maple_content_to_the_top_value').closest('.option-container') ).addClass('hiddenoption') , 0);
			}
		}).trigger('change');
		
		if (jQuery('#maple_header_type_value').val() != 'without'){
			if (jQuery('#maple_hide_pagetitle_value').val() == 'yes'){
				jQuery('#maple_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#maple_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
			} else jQuery('#maple_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('.obsoluteoptionoptions')).css('display','none');
		}
		jQuery('#maple_hide_pagetitle_value').change(function(){
			if (jQuery('#maple_header_type_value').val() != 'without'){
				if (jQuery('#maple_hide_pagetitle_value').val() == 'yes'){
					jQuery('#maple_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#maple_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
				} else jQuery('#maple_hide_pagetitle_value').closest('.option-container').nextUntil(jQuery('#maple_header_text_margin_top_noncename').parent().next()).css('display','none');
			}
		});
		
		if (jQuery('#maple_header_type_value').val() != 'without'){
			if (jQuery('#maple_hide_sec_pagetitle_value').val() == 'yes'){
				jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('#maple_header_text_margin_top_noncename').parent().next()).not('script').css('display','block');
			} else jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('#maple_header_text_margin_top_noncename').parent().next()).css('display','none');
		}
		
		jQuery('#maple_hide_sec_pagetitle_value').change(function(){
			if (jQuery('#maple_header_type_value').val() != 'without'){
				if (jQuery('#maple_hide_sec_pagetitle_value').val() == 'yes'){
					jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('.breadcrumboptions')).not('script').css('display','block');
				} else jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').nextUntil(jQuery('.breadcrumboptions')).css('display','none');
			}
		});
		
		jQuery('#maple_pagetitle_image_overlay_value').change(function(){
			if (jQuery(this).val() == "on"){
				jQuery('#maple_pagetitle_overlay_type_value').closest('.option-container')
					.add(jQuery('#maple_pagetitle_overlay_opacity_noncename').closest('.option-container'))
				.css('display','block');
				jQuery('#maple_pagetitle_overlay_type_value').change();
			} /*
else {
				jQuery('#maple_pagetitle_overlay_type_value').closest('.option-container').nextUntil(jQuery('#maple_pagetitle_overlay_opacity_slider').closest('.option-container').next()).andSelf()
					.add(jQuery('#maple_pagetitle_overlay_pattern_value').closest('.option-container'))
				.css('display','none');
			}
*/
		});
		
		jQuery('#maple_pagetitle_overlay_type_value').change(function(){
			if (jQuery(this).val() == "color"){
				jQuery('#maple_pagetitle_overlay_color').closest('.option-container').css('display','block');
				jQuery('#maple_pagetitle_overlay_pattern_noncename').closest('.option-container').css('display','none');
			} else {
				jQuery('#maple_pagetitle_overlay_color').closest('.option-container').css('display','none');
				jQuery('#maple_pagetitle_overlay_pattern_noncename').closest('.option-container').css('display','block');
			}
		});
		
		jQuery('#maple_header_type_value').change(function(){
			switch (jQuery('#maple_header_type_value').val()){
				case "without":
					jQuery('#maple_header_image_noncename').closest('.option-container').nextUntil(jQuery('#maple_breadcrumbs_margin_top_noncename').closest('.option-container')).add(jQuery('#maple_breadcrumbs_margin_top_noncename').closest('.option-container')).add(jQuery('#maple_header_image_noncename').closest('.option-container')).css('display','none');	
				break;
				case "color":
					jQuery('#maple_header_image_noncename').closest('.option-container')
						.add(jQuery('#maple_header_pattern_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_custom_pattern_noncename').closest('.option-container'))
						.add(jQuery('#maple_banner_slider_value').closest('.option-container'))
					.css('display','none');
					jQuery('#maple_header_color_noncename').closest('.option-container').add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#maple_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_height_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_color_opacity_noncename').closest('.option-container'))
						.add(jQuery('#maple_page_title_padding_noncename').closest('.option-container'))
						.add(jQuery('.breadcrumboptions').nextUntil(jQuery('.obsoluteoptionoptions')).andSelf())
					.css('display','block');
					
					jQuery('#maple_pagetitle_image_parallax_value').closest('.option-container').nextUntil(jQuery('#maple_pagetitle_overlay_opacity_noncename').closest('.option-container').next()).andSelf().css('display','none');
					jQuery('#maple_pagetitle_image_parallax_value').closest('.option-container').css('display','block');
					jQuery('#maple_hide_sec_pagetitle_value').add(jQuery('#maple_hide_pagetitle_value')).add(jQuery('#maple_enable_breadcrumbs_value')).trigger('change');
				break;
				case "image":
					jQuery('#maple_header_color_noncename').closest('.option-container')
						.add(jQuery('#maple_header_pattern_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_custom_pattern_noncename').closest('.option-container'))
						.add(jQuery('#maple_banner_slider_value').closest('.option-container'))
						.add(jQuery('#maple_header_color_opacity_noncename').closest('.option-container'))
					.css('display','none');
					jQuery('#maple_header_image_noncename').closest('.option-container').add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#maple_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_height_noncename').closest('.option-container'))
						.add(jQuery('#maple_page_title_padding_noncename').closest('.option-container'))
					...
					// erererererere
					jQuery('#maple_pagetitle_image_parallax_value').closest('.option-container').add(jQuery('#maple_pagetitle_image_overlay_value').closest('.option-container')).css('display','block');
					jQuery('#maple_pagetitle_image_overlay_value').change();
					
				break;
				case "pattern":
					jQuery('#maple_header_image_noncename').closest('.option-container')
						.add(jQuery('#maple_header_color_noncename').closest('.option-container'))
						.add(jQuery('#maple_banner_slider_value').closest('.option-container'))
						.add(jQuery('#maple_header_custom_pattern_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_color_opacity_noncename').closest('.option-container'))
					.css('display','none');
					jQuery('#maple_header_pattern_noncename').closest('.option-container')
						.add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#maple_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_height_noncename').closest('.option-container'))
						.add(jQuery('#maple_page_title_padding_noncename').closest('.option-container'))
				...
				case "custom_pattern":
					jQuery('#maple_header_image_noncename').closest('.option-container')
						...
						.add(jQuery('#maple_header_color_opacity_noncename').closest('.option-container'))
					.css('display','none');
					jQuery('#maple_header_custom_pattern_noncename').closest('.option-container')
						.add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#maple_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_height_noncename').closest('.option-container'))
				...
				case "banner":
					...
					jQuery('#maple_banner_slider_value').closest('.option-container').add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container')).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container'))
						.add(jQuery('#maple_hide_sec_pagetitle_value').closest('.option-container').prev()).add(jQuery('#maple_hide_pagetitle_value').closest('.option-container').prev())
						.add(jQuery('#maple_header_text_alignment_noncename').closest('.option-container'))
						.add(jQuery('#maple_header_height_noncename').closest('.option-container'))
						.add(jQuery('.breadcrumboptions').nextUntil(jQuery('.obsoluteoptionoptions')).andSelf())
		...
		if (jQuery('#post_type').length > 0){
			if (jQuery('#post_type').val() == "page"){
				...
				jQuery('#sidebars_available_value').add(jQuery('#sidebars_available_value').siblings()).wrapAll('<div class="maple_sidebars_available" style="display:none;"/>');
				jQuery('#pageparentdiv.postbox .inside').css('display','inline-block').append(jQuery('.maple_sidebars_available'));
				jQuery('#pageparentdiv.postbox .inside .des_layouts').each(function(){
					...
					if (jQuery('#pageparentdiv.postbox .inside .des_layouts.selected').attr('title') === "none"){
						jQuery('#pageparentdiv.postbox .inside .maple_sidebars_available').css('display','none');
					} else {
						jQuery('#pageparentdiv.postbox .inside .maple_sidebars_available').css('display','block');
					}
			...
			if (jQuery('#post_type').val() == "post"){
				jQuery('#categorydiv').before('<div id="maple_post_layout" class="postbox"><h2 class="hndle ui-sortable-handle"><span>Sidebar Layout</span></h2><div class="inside"><div class="maple_post_layout"><label for="enable_post_custom_sidebar_layout" >Enable Custom Sidebar Layout<input type="checkbox" name="enable_post_custom_sidebar_layout" /></label><div class="des_layouts" title="none" /><div class="des_layouts" title="left" /><div class="des_layouts" title="right" /></div></div></div></div>');
				...
				jQuery('input[name="enable_post_custom_sidebar_layout"]').change(function(){
					if (jQuery(this).is(':checked')) {
						...
						if (jQuery('#maple_post_layout.postbox .inside .des_layouts.selected').attr('title') === "none"){
							jQuery('#maple_post_layout.postbox .inside .maple_sidebars_available').css('display','none');
						} else {
							jQuery('#maple_post_layout.postbox .inside .maple_sidebars_available').css('display','block');
						}
						jQuery('#enable_post_custom_sidebar_layout_value').val("true");
					} else {
						jQuery('.des_layouts').add(jQuery('.maple_sidebars_available')).css('display','none');
						jQuery('#enable_post_custom_sidebar_layout_value').val("false");
					}
				});
				
				if (jQuery('#enable_post_custom_sidebar_layout_value').val() == "true"){
					jQuery('.des_layouts').add(jQuery('.maple_sidebars_available')).css('display','block');
				...
				jQuery('#sidebars_available_value').add(jQuery('#sidebars_available_value').siblings()).wrapAll('<div class="maple_sidebars_available" style="display:none;"/>');
				jQuery('#maple_post_layout.postbox .inside').css('display','inline-block').append(jQuery('.maple_sidebars_available'));
				
				
				
				jQuery('#maple_post_layout.postbox .inside .des_layouts').each(function(){
					if (jQuery(this).attr('title') === jQuery('#sidebar_for_default_value').val()){
						jQuery(this).addClass('selected');
					} else {
						jQuery(this).removeClass('selected');
		...
		twPageOptions.updateHomeStyleOptions();
		jQuery('#page_template').add(jQuery('#maple_header_type_value')).trigger('change');
	},
	...
	updateCustomPageOpts: function(){
		...
		switch (jQuery('#page_template').val()){
			...
			case "one-page-template.php":
				...
				toggleHomepageOptions("hide");
				jQuery('#pageparentdiv.postbox .inside > h4, #pageparentdiv.postbox .inside > .maple_sidebars_available, #pageparentdiv.postbox .inside > div.des_layouts').css('display','none');
				jQuery('#obsoluteoption_rev_value').closest('.option-container').add(jQuery('#obsoluteoption_rev_value').closest('.option-container').prev()).css('display','none');
			...
			case "template-home.php":
				...
				togglePageOptions("hide");
				jQuery('.blogoptions').nextUntil(jQuery('.pagetitleoptions')).andSelf().css('display','none');
				jQuery('#maple_enable_custom_header_options_value').closest('.option-container').css('display','block').removeClass('hiddenoption');
				twPageOptions.updateHomeStyleOptions();
			break;
...
function togglePageOptions(action){
	switch (action){
		case "show":
			...
			jQuery('#maple_enable_custom_pagetitle_options_value').trigger('change');
			jQuery('#maple_enable_custom_header_options_value').trigger('change');
			break;
		case "hide":
