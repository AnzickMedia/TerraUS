...
$maple_info_options= array( array(
"name" => "Header Layout",
"type" => "title",
"img" => MAPLE_IMAGES_URL."icon_home.png"
),
...
array(
	"name" => "Header Style",
	"id" => "maple_header_style_light_dark",
	"type" => "select",
...
array(
	...
	"id" => "maple_header_after_scroll_style_light_dark",
	"type" => "select",
	"options" => array(array("id"=>"light","name"=>"Light (for Dark logos)"), array("id"=>"dark","name"=>"Dark (for Light logos)")),
	"desc" => "If you choose the <strong>Light Style</strong> the theme will apply the <strong>Dark</strong> logo and menu settings.<br/> If you choose the <strong>Dark Style</strong> the theme will apply the <strong>Light</strong> logo and menu settings. ",
	"std" => "light"
...
array(
	...
	"id" => "maple_logo_retina_image_url_light",
	"type" => "upload_from_media",
	"desc" => "Upload your logo image - with png/jpg/gif extension.",
...
array(
	...
	"id" => "maple_logo_image_url_dark",
	"type" => "upload_from_media",
	"desc" => "Upload your logo image - with png/jpg/gif extension.",
	"std" => "http://treethemes.net/themes/maple/demo1/wp-content/uploads/sites/2/2017/02/logo_dark-1.png"
),

array(
	"name" => "Logo <strong>Dark</strong> Retina URL",
	"id" => "maple_logo_retina_image_url_dark",
	"type" => "upload_from_media",
	"desc" => "Upload your logo image - with png/jpg/gif extension.",
	"std" => "http://treethemes.net/themes/maple/demo1/wp-content/uploads/sites/2/2017/02/logo_dark@2x.png"
),
...
array(
	...
	"id" => "maple_logo_intro_retina_image_url",
	"type" => "upload_from_media",
	"desc" => "Upload your logo image - with png/jpg/gif extension.",
	"std" => "http://treethemes.net/themes/maple/demo1/wp-content/uploads/sites/2/2017/02/logo_dark@2x.png"
),
...
"id"=>'top_panel'
	...
	array(
		...
		"id" => "maple_enable_search_everything",
		"type" => "checkbox",
		"std" => 'on',
	...
	array(
		...
		"id" => "maple_search_secondary_title",
		"type" => "text",
	...
	array(
		"name" => "Sidebar ?",
		"id" => "maple_search_archive_sidebar",
		"type" => "select",
	...
	array(
		...
		"id" => "maple_search_sidebars_available",
		"type" => "select",
	...
	array(
		...
		"id" => "maple_search_show_categories",
		"type" => "checkbox",
		"std" => 'off'
	),
...
maple_add_options($maple_info_options);