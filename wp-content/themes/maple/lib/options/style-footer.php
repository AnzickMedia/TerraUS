<?php
	...
	array(
		...
		"id" => "maple_footerbg_color_opacity",
		"type" => "opacity_slider",
		"std" => "100"
	),
	...
	array(
		"name" => "Custom Pattern",
		"id" => "maple_footerbg_custom_pattern",
		"type" => "upload_from_media",
	...
	array(
		"name" => "Borders Color",
		"id" => "maple_footerbg_borderscolor",
		"type" => "color",
		"std" => '191919'
	),
	...
	array(
		"name" => "Padding Top",
		"id" => "maple_primary_footer_padding_top",
		"type" => "text",
		"std" => "80px"
	),
	...
	array(
		"name" => "Padding Bottom",
		"id" => "maple_primary_footer_padding_bottom",
		"type" => "text",
		"std" => "80px"
	),
	...
	array(
		...
		"id" => "maple_footerbg_paragraphscolor",
		"type" => "color",
		"std" => '999999'
	),
	...
	array(
		"name" => "Headings Color",
		"id" => "maple_footerbg_headingscolor",
		"type" => "color",
		"std" => 'ffffff'
	),
	...
	array(
		"name" => "Background Opacity",
		"id" => "maple_sec_footerbg_color_opacity",
		"type" => "opacity_slider",
		"std" => "100"
	),
	...
	array(
		"name" => "Custom Pattern",
		"id" => "maple_sec_footerbg_custom_pattern",
		"type" => "upload_from_media",
		"desc" => 'Here you can choose the custom pattern for your footer. It will replace the pattern you choose above.'
	),
	...
	array(
		"name" => "Padding Top",
		"id" => "maple_secondary_footer_padding_top",
		"type" => "text",
		"std" => "80px"
	),
	...
	array(
		"name" => "Padding Bottom",
		"id" => "maple_secondary_footer_padding_bottom",
		"type" => "text",
		"std" => "80px"
	),
	...
	array(
		...
		"id" => "maple_sec_footer_social_icons_size",
		"type" => "text",
		"std" => "20px"
	),
	...
	array(
		...
		"id" => "maple_sec_footer_social_icons_color",
		"type" => "color",
		"std" => "333333"
	),
	...
	array(
		...
		"id" => "maple_sec_footer_social_icons_hover_color",
		"type" => "color",
		"std" => "d8d8d8"
	),
