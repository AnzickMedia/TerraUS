<?php
	...
	array(
		...
		"id" => "maple_search_input_background_color",
		"type" => "color",
		"std" => "ffffff"
	),
	...
	array(
		...
		"id" => "maple_search_input_background_opacity",
		"type" => "opacity_slider",
		"std" => "98"
	),
	...
	array(
		"name" => "Font Size",
		"id" => "maple_search_input_font_size",
		"type" => "slider",
		"std" => "30px"
	),
	...
	array(
		"name" => "Font Color",
		"id" => "maple_search_input_font_color",
		"type" => "color",
		"std" => "444444"
	),
	...
	array(
		"name" => "Background Color",
		"id" => "maple_search_result_background_color",
		"type" => "color",
		"std" => "ffffff"
	),
	...
	array(
		...
		"id" => "maple_search_selected_result_background_color",
		"type" => "color",
		"std" => "f2f2f2"
	),
	...
	array(
		"name" => "Background Opacity",
		"id" => "maple_search_result_background_opacity",
		"type" => "opacity_slider",
		"std" => "98"
	),
	...
	array(
		"name" => "Borders",
		"id" => "maple_search_result_borders",
		"type" => "color",
		"std" => "dedede"
	),
	...
	array(
		"name" => "Font Size",
		"id" => "maple_search_result_font_size",
		"type" => "slider",
		"std" => "14px"
	),
	...
	array(
		"name" => "Font Color",
		"id" => "maple_search_result_font_color",
		"type" => "color",
		"std" => "696969"
	),
	...
	array(
		...
		"id" => "maple_search_selected_result_font_color",
		"type" => "color",
		"std" => "3d3d3d"
	),
	...
	array(
		"name" => "Font",
		"id" => "maple_search_result_details_font",
		"type" => "select",
		"options" => $maple_fonts_array,
		"std" => "Helvetica Neue"
	),
	...
	array(
		"name" => "Font Size",
		"id" => "maple_search_result_details_font_size",
		"type" => "slider",
		"std" => "12px"
	),
	...
	array(
		"name" => "Font Color",
		"id" => "maple_search_result_details_font_color",
		"type" => "color",
		"std" => "c2c2c2"
	),
	...
	array(
		...
		"id" => "maple_search_selected_result_details_font_color",
		"type" => "color",
		"std" => "c2c2c2"
	),
