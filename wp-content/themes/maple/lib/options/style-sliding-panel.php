<?php
	...
	array(
		...
		"id" => "maple_sliding_panel_background_color",
		"type" => "color",
		"std" => "1a1a1a"
	),
	...
	array(
		"name" => "Font",
		"id" => "maple_sliding_panel_titles_font",
		"type" => "select",
	...
	array(
		"name" => "Font Color",
		"id" => "maple_sliding_panel_titles_color",
		"type" => "color",
		"std" => "ffffff"
	),
	...
	array(
		"name" => "Font Size",
		"id" => "maple_sliding_panel_titles_font_size",
		"type" => "slider",
		"std" => "16px",
	...
	array(
		"name" => "Font",
		"id" => "maple_sliding_panel_links_font",
		"type" => "select",
		"options" => $maple_fonts_array,
		"desc" => 'You can select one of the fonts that the theme goes with or you can add google fonts (Style Options > Fonts).',
		"std" => "Helvetica Neue"
	...
	array(
		"name" => "Font Color",
		"id" => "maple_sliding_panel_links_color",
		"type" => "color",
		"std" => "6e6e6e"
	),
	...
	array(
		...
		"id" => "maple_sliding_panel_links_color_hover",
		"type" => "color",
		"std" => get_option('maple_style_color')
	),
	
	array(
		"name" => "Font Size",
		"id" => "maple_sliding_panel_links_font_size",
		"type" => "slider",
		"std" => "16px",
		"desc" => "Change the size of your menu font."
	),
	...
	array(
		"name" => "Font Color",
		"id" => "maple_sliding_panel_p_color",
		"type" => "color",
		"std" => "ededed"
	),
	...
	array(
		"name" => "Font Size",
		"id" => "maple_sliding_panel_p_font_size",
		"type" => "slider",
		"std" => "14px",
		"desc" => "Change the size of your menu font."
	),
