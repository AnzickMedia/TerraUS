...
get_header(); maple_print_menu();
	...
	if (get_post_meta($maple_thisPostID, "maple_enable_custom_pagetitle_options_value", true) == "no" || !get_post_meta($maple_thisPostID, "maple_enable_custom_pagetitle_options_value", true)){
		...
		//$height = get_post_meta($maple_thisPostID, "maple_header_height_value", true);
	...
	if (defined('MAPLE_IS_FIRST_PAGE')) $sidebar_scheme = get_option('maple_blog_archive_sidebar');
	...
	switch ($sidebar_scheme){
		case "none":
			if (!defined("MAPLE_IS_FIRST_PAGE") && $post->post_content != ""){
				?>
	...
	function maple_print_blog($pageid){
	    ...
	    global $post, $wp_query, $maple_the_query, $maple_import_fonts;
